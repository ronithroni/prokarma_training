...
public class GenerateTasks implements Runnable {
	...
	public void run() {
		...
		try {
			String filePath = "C:\\maven-examples\\maven-basics\\Weekend3\\src\\main\\java\\com\\week3\\assignment";
			String filename = "Task-Generated-Single-";
		...
		try {
			buffer.write(
					"S.no,MainTaskTitle,MainTaskDescription,SubTaskTitle,SubTaskDescription,EstimatedHours,AssignedPerson,Age");
			buffer.newLine();
	...
	public static String GetCurrentTimeStamp() {
		SimpleDateFormat sdfDate = new SimpleDateFormat("MMM-dd-yyyy-HH:mm:ss");
		Date now = new Date();
